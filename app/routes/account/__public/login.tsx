...
export const action: ActionFunction = async ({request, context, params}) => {
  ...
  try {
    ...
    return badRequest({
      formError:
        "Sorry. We did not recognize either your email or password, or you may not have confirmed your email yet. If you've just registered, check your email for confirmation or try again",
    });
  }
};
