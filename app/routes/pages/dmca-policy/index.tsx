  ...
  return (
    <div className="p-4 pl-3 text-sm md:text-lg">
      ...
      <p className="text-sm md:text-md md:pl-4">
        ...
        certain, specific ways. Many types of works are eligible for copyright
        protection, including audiovisual words, sound recordings and musical
        compositions, written works, visual works, video games and computer
      ...
      <p className="text-sm md:text-md md:pl-4">
        ...
        MoshiProject are new, original, and/or transformative works that may
        parody, satirize, or provide social commentary on other copyrighted
        works. MoshiProject and the selected designs make only fair use of the
        copyrighted works of others. MoshiProject respects the copyrights of
        others, and MoshiProject is not affiliated with the owners of the
      ...
      <p className="text-sm md:text-md md:pl-4">
        ...
        removing or disabling access to a design claimed to be infringing. If
        MoshiProject removes or disables access in response to such a notice,
        MoshiProject will make a good-faith attempt to contact the independent
        artist who submitted the design to MoshiProject so that the artist may
        make a counter-notification pursuant to Section 512(g)(2) and (3) of the
        DMCA.
      </p>
      <br />
      <p className="text-sm md:text-md md:pl-4">
      ...
      <p className="text-sm md:text-md md:pl-4">
        ...
        Millennium Copyright Act (“DMCA”), moshiproject.com designates the
        following individual as its agent for receipt of notifications of
        claimed infringement: by first or second class mail to moshiproject.com,
        Attn: Legal Department, by email to contact@moshiproject.com To be
